...
masterRoutes.route('/GetSingleVechileDetails').post(async function (req, res) {
...
masterRoutes.route('/GetEmployeevechileDetails').post(async function (req, res) {
...
masterRoutes.route('/VechileCheckIn').post(async function (req, res) {
...
masterRoutes.route('/VechileCheckOut').post(async function (req, res) {
...
masterRoutes.route('/getEmployeevechileReport').post(async function (req, res) {
...
// EmpBooking Details
masterRoutes.route('/InsertEmpBookingDetails').post(async function (req, res) {
...
masterRoutes.route('/updateEmployeeBookingDetails').post(async function (req, res) {
...
masterRoutes.route('/SingleEmployeeBookingReport').post(async function (req, res) {
...
masterRoutes.route('/getVisitorbookingReport').post(async function (req, res) {
...
masterRoutes.route('/getempAppointmentedit').post(async function (req, res) {
